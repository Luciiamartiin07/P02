...
let position1 = {
    top: parseInt(window.getComputedStyle(cuadrado1).top) || 0,//obtiene los estilos claculados de un elemento
...
function checkCollision() {
    ...
    if (
        position2.left < position4.left + enemigo2Width &&//verifica si el lado izquierdo del coche está antes del lado derecho
        position2.left + cuadrado2Width > position4.left &&//verifica si el lado derecho del coche está antes del lado izquierdo
        position2.top < position4.top + enemigo2Height &&///verifica si el lado superior del coche está antes del lado inferior
        position2.top + cuadrado2Height > position4.top///verifica si el lado inferior del coche está antes del lado superior
    ) {
        alert('Colisión detectada');
        // Bloquear movimiento de ambos por 5 segundos
        canMove1 = false;
